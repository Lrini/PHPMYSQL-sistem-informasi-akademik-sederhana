				...
				<div class="box">
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align='center'>
							...
							<?php
							$result = mysqli_query($conn,"SELECT * FROM mengajar");
							...
							echo "
								...
								<td> <i> <a href='UpdateMengajar.php?id_mengajar=".$data['id_mengajar']."' class='ico edit'> Update </a> </i></td>
								<td> <i> <a href='DeleteMengajar.php?id_mengajar=".$data['id_mengajar']."' onClick='return warning()' class='ico del'> Delete </a> </i></td>
								</tr>";
							}
							?>
						</table>
