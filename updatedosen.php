...
$hasil = mysqli_query($conn,"select * from dosen where ID_DOSEN ='$data2'");
?>
...
<div id="header">
	<div class="shell">
		<!-- Logo + Top Nav -->
		<div id="top">
			<h1><a href="admin_homepage.php"><img src = "h.png"></a></h1>
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					...
					<!-- Table -->
					<div class="table">
<form name="update" action="UpdateTabelDosen.php" method="post">
...
<center>
							...
							<tr>
										...
										<td><input name="NAMA_DOSEN" type="text" value="<?php echo $data['nama']?>" class="field size1" ></td>
