...
// seperti sebelunya, kita membuat class anakan dari class FPDF
 class PDF extends FPDF{
  ...
  // $this->Image('logo.png',1,1,2.25); // logo
   ...
   $this->Cell(19,1,'LAPORAN Mahasiswa',0,0,'C');
   $this->Ln();
   $this->Cell(19,1,'Jurusan Ilmu komputer',0,0,'C');
   $this->Ln();
   ...
   $this->Cell(1,1,'Nim','TB',0,'L',1); // cell dengan panjang 2
   $this->Cell(2,1,'Nama','TB',0,'C',7); // cell dengan panjang 3
