...
$data2= $_GET['nim'];
$hasil = mysqli_query($conn,"select * from nilai where nim ='$data2'");
?>
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					...
					<!-- Table -->
					<div class="table">
<form name="update" action="UpdateTabelNilai.php" method="post">
...
<center>
							...
							<tr>
										...
										<td><input name="nim" type="text" disabled='disable' value="<?php echo $data['nim']?>" class="field size1" ></td>
							...
							<tr>
										...
										<td><input name="nilai" type="text" value="<?php echo $data['nilai']?>" class="field size1" required="required" ></td> 
