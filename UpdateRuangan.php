...
$data2= $_GET['id_ruangan'];
$hasil = mysqli_query($conn,"select * from ruangan where id_ruangan ='$data2'");
?>
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Update Ruangan</h2>
					</div>
					<!-- End Box Head -->	
					<!-- Table -->
					<div class="table">
<form name="update" action="UpdateTabelRuang.php" method="post">
