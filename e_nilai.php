					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align='center'>
							<tr align='center'>
									...
									<td width="200px"> <b> ID MATAKULIAH </b> </td>
							...
							echo "
								...
								<td>".$data['nilai']."</td>
								<td> <i> <a href='UpdateNilai.php?nim=".$data['nim']."' class='ico edit'> Update </a> </i></td>
								<td> <i> <a href='DeleteNilai.php?nim=".$data['nim']."' onClick='return warning()' class='ico del'> Delete </a> </i></td>
								</tr>";
							}
							?>
						</table>
