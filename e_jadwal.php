					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align='center'>
							...
							echo "
								...
								<td>".$data['jam']."</td>
								<td>".$data['status']."</td>
								<td> <i> <a href='UpdateJadwal.php?id_jadwal=".$data['id_jadwal']."' class='ico edit'> Update </a> </i></td>
								<td> <i> <a href='DeleteJadwal.php?id_jadwal=".$data['id_jadwal']."' onClick='return warning()' class='ico del'> Delete </a> </i></td>
								</tr>";
							}
							?>
						</table>
