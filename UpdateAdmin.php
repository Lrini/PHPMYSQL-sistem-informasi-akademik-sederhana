...
$data2= $_GET['user'];
$hasil = mysqli_query($conn,"select * from admin where user ='$data2'");
?>
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					...
					<!-- Table -->
					<div class="table">
<form name="update" action="UpdateTabelAdmin.php" method="post">
...
<center>
							<table border="0">
							<tr>
										<td width="200px"><p align="left"><label>user : </label></p></td>
										<td><input name="user" type="text" disabled='disable' value="<?php echo $data['user']?>" class="field size1" ></td>
									
							</tr>
							<tr>
										<td width="200px"><p align="left"><label>ID DOSEN : </label></p></td>
										<td><input name="pass" type="text" value="<?php echo $data['pass']?>" class="field size1" ></td>
