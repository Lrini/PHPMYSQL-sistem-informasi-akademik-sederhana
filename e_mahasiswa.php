					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align='center'>
							...
							echo "
								...
								<td>".$data['nim_mhs']."</td>
								<td>".$data['nama']."</td>
								<td> <i> <a href='UpdateMahasiswa.php?nim=".$data['nim_mhs']."' class='ico edit'> Update </a> </i></td>
								<td> <i> <a href='DeleteMahasiswa.php?nim=".$data['nim_mhs']."' onClick='return warning()' class='ico del'> Delete </a> </i></td>
								</tr>";
							}
							?>
						</table>
