...
$hasil = mysqli_query($conn,"select * from mahasiswa where nim_mhs ='$data2'");
?>
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Update Dosen</h2>
					</div>
					<!-- End Box Head -->	
					<!-- Table -->
					<div class="table">
<form name="update" action="UpdateTabelMahasiswa.php" method="post">
...
<center>
							...
							<tr>
										...
										<td><input name="nim" type="text" disabled='disable' value="<?php echo $data['nim_mhs']?>" class="field size1" ></td>
									
							</tr>
							<tr>
										<td width="200px"><p align="left"><label>NAMA Mahasiswa : </label></p></td>
										<td><input name="nama" type="text" value="<?php echo $data['nama']?>" class="field size1" ></td>
...
<br><br><br>
						<div class="buttons">
							<input type="hidden" name="nim" value="<?php echo $data['nim_mhs']; ?>">
